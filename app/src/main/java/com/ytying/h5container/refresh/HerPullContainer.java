 ...
 */
public class HerPullContainer extends FrameLayout implements OverScrollListener{
    ...
    public HerPullContainer(Context context) {
        super(context);
    }

    public HerPullContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HerPullContainer(Context context, AttributeSet attrs, int defStyle) {
